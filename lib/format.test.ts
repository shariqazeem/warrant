...
import {runLabel, settledUnitPrice, short, unitsFromRaw, usdt} from "./format";
...
describe("money, at X Layer's decimals", () => {
  ...
  it("reads an xStock at eighteen", () => {
    expect(unitsFromRaw(ARRIVED, 18)).toBe("0.0225");
    expect(unitsFromRaw(ARRIVED, 18, 8)).toBe("0.02246398");
  });
